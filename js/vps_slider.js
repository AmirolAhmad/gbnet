...
$(document).ready(function(){
	...
	$( "#slider" ).slider({
		...
		slide: function( event, ui ) {
			$('.slider-container #storage_val').html(san_arr[ui.value-1]);
			$('.slider-container #cpu_val').html(cpu_arr[ui.value-1]);
			$('.slider-container #bandwidth_val').html(trans_arr[ui.value-1]);
			$('.slider-container #ip_val').html(ip_arr[ui.value-1]);
			...
			$(".slider-container div.vpsbox div").removeClass("current");
		...
		change: function( event, ui ) {
			...
			$('.slider-container a.buynow-button').attr('href', b_url + link_arr[ui.value-1]);
			for(var i=0;i<ui.value;i++)
				$(".slider-container div.vpsbox div#icon-"+i).addClass("current");
		}
	});
